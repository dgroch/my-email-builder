...
const OBJECTIVE_GUIDANCE = {
  ...
  editorial_digest: {
    ...
    blockSequence: ['header', 'blocks/caption-bar-hero', 'blocks/story', 'sections/section-headline', 'products/card-horizontal', 'blocks/journal-tile', 'sections/upsell-noir', 'sections/trust-bar', 'footer'],
    heroOptions: ['blocks/caption-bar-hero', 'blocks/editorial-hero'],
    proofModules: ['blocks/story', 'blocks/polaroid-collage', 'blocks/journal-tile'],
...
const COMPONENT_INTENT = {
  ...
  'blocks/image-text': {
    bestFor: ['product_spotlight', 'range_launch', 'value_prop', 'occasion_gifting'],
    avoidFor: ['discount_offer'],
    visualRole: '2/3-width image paired with a text column + button; IMG_SIDE flips image left/right',
    requiresImage: true, imageRatio: '400x500 (4:5)', tone: 'editorial, product-led',
  },
  'blocks/journal-tile': {
    bestFor: ['editorial_digest', 'lifecycle', 'social_proof'],
    avoidFor: ['discount_offer', 'occasion_gifting'],
    visualRole: 'a "From the Journal" row of 2–3 linked article tiles (live HTML, per-tile links)',
    requiresImage: true, imageRatio: '200x250 (4:5) per tile', tone: 'editorial, secondary reading',
    note: 'A "From the Journal" row of 2–3 linked article tiles. Live HTML (per-tile links). Editorial only — no price field.',
  },
  'heroes/hero-a': {
  ...
  'products/card-live': {
    bestFor: ['lifecycle', 'product_spotlight'],
    avoidFor: ['editorial_digest', 'education_howto'],
    visualRole: 'live-HTML product card: 4:5 photo left, name + note + price + button right; carries per-recipient Klaviyo tags',
    requiresImage: true, imageRatio: '280 wide, 4:5 (560x700 source)', tone: 'clean, product-led',
  },
  ...
  'sections/full-width-image': {
    bestFor: ['range_launch', 'product_spotlight', 'editorial_digest', 'occasion_gifting'],
    avoidFor: ['discount_offer'],
    visualRole: 'a single full-width image (live HTML — keeps its own link / GIF), no text',
    requiresImage: true, imageRatio: 'any (600 wide, natural height)', tone: 'photographic, minimal',
  },
};
