...
const SITE = 'https://figandbloom.com';
...
const COMPONENT_SAMPLES = {
  ...
  'blocks/journal-tile': {
    SECTION_LABEL: 'FROM THE JOURNAL', SECTION_HEADLINE: 'More from Kellie',
    TILE_1_IMAGE_URL: pick(IMG.squares, 1), TILE_1_EYEBROW: 'KELLIE', TILE_1_TITLE: 'Against the dozen red roses',
    TILE_1_TEASER: 'The thing florists aren’t supposed to say.', TILE_1_LINK_URL: 'https://figandbloom.com/blogs/news/against-the-dozen-red-roses',
    TILE_2_IMAGE_URL: pick(IMG.squares, 2), TILE_2_EYEBROW: 'KELLIE', TILE_2_TITLE: 'Why every bouquet is named after a place',
    TILE_2_TEASER: 'The design process, from a room to a bouquet.', TILE_2_LINK_URL: 'https://figandbloom.com/blogs/news/our-design-process-zanzibar-bouquet',
    TILE_3_IMAGE_URL: pick(IMG.squares, 3), TILE_3_EYEBROW: 'KELLIE', TILE_3_TITLE: 'Why I’m particular about pink',
    TILE_3_TEASER: 'A fashion eye, brought to one difficult colour.', TILE_3_LINK_URL: 'https://figandbloom.com/blogs/news/why-is-pink-so-popular',
  },
  'blocks/image-text': {
    IMAGE_URL: IMG.hero, IMG_SIDE: 'left', SUPER_LABEL: 'NEW THIS WEEK',
    HEADLINE: 'A closer look at this week’s bloom',
    BODY: 'Hand-tied the morning it’s sent, with stems chosen to last — and a note we’ll write by hand.',
    CTA_TEXT: 'Shop the bloom', CTA_URL: SITE + '/collections/bouquets',
  },
  'sections/full-width-image': {
    IMAGE_URL: IMG.hero, ALT_TEXT: 'A hand-tied seasonal bouquet, photographed in soft morning light.',
    LINK_URL: SITE + '/collections/bouquets',
  },
  'products/card-live': {
    PRODUCT_IMAGE_URL: 'https://cdn.shopify.com/s/files/1/0657/8723/2489/files/Savoie-Large-Bouquet.jpg?v=1764283935&width=560&height=700',
    PRODUCT_LABEL: 'BACK IN STOCK', PRODUCT_NAME: 'Savoie bouquet',
    PRODUCT_NOTE: 'Choose your day at checkout, and we’ll take care of the rest.',
    PRODUCT_PRICE: 'Signature · $195.00', CTA_TEXT: 'See it again', PRODUCT_URL: SITE + '/products/savoie',
  },
  'sections/button': { CTA_TEXT: 'Shop the collection', CTA_URL: SITE + '/collections/bouquets' },
...
function sampleTokensFor(comp, opts = {}) {
  ...
  for (const t of comp.tokens) {
    ...
    if (t.default !== undefined) {
      v = t.default;                        // manifest token_defaults (e.g. PADDING_TOP)
