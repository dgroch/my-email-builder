...
|---|---|---|---|
| **Shopify products** | Active bouquets, arrangements, vases, candles, cards — title, handle, from-price, image, tags | Public `figandbloom.com/products.json` (no auth — use the canonical `.com`; `.com.au` is legacy and only 301s) | Same, or a richer Admin API pull |
