...
// Every template opens with a COMPONENT/TOKENS/RULES comment, and those comments discuss the
// very properties this scans for — a component documenting "uses a fixed-width table, not
// max-width" would report itself broken. Strip ordinary comments before scanning, but keep the
// conditional ones: `<!--[if gte mso 9]>` wraps real VML, and the downlevel-revealed
...
module.exports = { assemble, assembleBlocks, wrapProductionShell, preheader, isUnsubscribeBlock, isHtmlOnlyComponent, deriveLink, deriveAlt, isGifUrl, withDefaults, renderToPng, renderSlices, closeBrowser, applyOutlookDegradation, outlookRisks, OUTLOOK_UNSUPPORTED, DS };
