...
function assemble(campaign, opts = {}) {
  ...
  (campaign.blocks || []).forEach((block, i) => {
    ...
    if (opts.markBlocks) parts.push(`<div data-eb-block="${i}" data-eb-component="${escAttr(block.component)}">\n${html}\n</div>`);
...
module.exports = { assemble, renderToPng, renderSlices, closeBrowser, DS };
